...
## Usage    
The application is simple to use. It automatically retrives the data for you and it supports both light and dark mode. The application is also responsive and can be used on mobile devices and tablets.
